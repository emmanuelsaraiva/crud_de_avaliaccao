          ...
          <tbody>
            ...
            ?>
              <tr>
                  ...
                  <td> <input type="text" class="form-control" name="email_aluno" value="<?php echo $email_aluno; ?>"> </td>
                  ...
                  <td>
                    ...
                    <td>  </td>
                    <td> <input type="hidden" name="nome_aluno"> </td>
                    <td> <input type="hidden" name="email_aluno"> </td>
                    <td> <input type="hidden" name="nascimento_aluno"> </td>
                    <td> <input type="hidden" name="sexo_aluno"> </td>
                    <td> <input type="hidden" name="matricula_aluno"> </td>
                    <td> <input type="hidden" name="telefone_aluno"> </td>
